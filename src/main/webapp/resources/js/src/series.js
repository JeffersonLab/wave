    ...
    (function (wave) {
        wave.Series = class Series {
            ...
            constructor(pv) {
                ...
                this.preferences = {color: null, label: null, yAxisLabel: null, yAxisMin: null, yAxisMax: null, scaler: null}; /* Unlike metadata, this is maintained across fetch refreshes */
